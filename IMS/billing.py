...
class billClass:
    def __init__(self,root):
        ...
        btn_clear_cart=Button(cart_widgets_Frame,text="Clear",command=self.clear_cart,font=("times new roman",12),bg="beige",fg="green",cursor="hand2").place(x=180,y=70,width=100,height=30)
        btn_add_cart=Button(cart_widgets_Frame,text="Add | Update Cart",command=self.add_update_cart,font=("times new roman",12),bg="beige",fg="green",cursor="hand2").place(x=310,y=70,width=150,height=30)
